...
Status: active contract, verified against exact registry release `@gouno/ui@0.4.8` during the 2026-09-15 Gosso Admin Showcase Parity Hardening pass.
...
The current exact package baseline is `@gouno/ui@0.4.8`, generated by the registry-sync workflow with npm registry tarball/integrity verification. Future shared-loading changes must continue to:
