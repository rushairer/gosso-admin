...
import { Alert, Button, FormField, IconButton, Input } from '@gouno/ui/core';
...
export default function ResetPassword() {
  ...
  return (
    <AuthPageSurface title={t('passwordReset.resetTitle')} description={t('passwordReset.resetDescription')}>
